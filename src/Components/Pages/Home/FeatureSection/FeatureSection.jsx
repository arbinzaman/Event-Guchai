          ...
          <div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:dark:bg-violet-400 dark:dark:text-gray-900">
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="leadi">
                  Simplify event planning with intuitive tools for scheduling,
                  budgeting, and task management. Increase productivity and save
                  time with automated processes and centralized event
                  management.
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="leadi">
                  Receive dedicated support from a team of experts throughout
                  the event planning process. Ensure the security of attendee
                  data and transactions with robust security measures and
          ...
          <div className="lg:w-1/2 xl:w-3/5 dark:dark:bg-gray-800">
            <div className="flex items-center justify-center p-4 md:p-8 lg:p-12">
              <img
                ...
                alt=""
                className="rounded-lg shadow-lg dark:dark:bg-gray-500 aspect-video sm:min-h-96"
              />
            </div>
          </div>
        </div>
